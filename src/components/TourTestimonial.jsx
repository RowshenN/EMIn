...
const TourTestimonial = ({ tour_tests, id }) => {
  ...
  const posTestimonial = async (e) => {
    ...
    setSubmitting(true);
    try {
      const response = await axiosInstance.post("/destinations/testimonials", data, {
        // Send the object
        headers: {
  ...
  return (
    <div className="w-full relative overflow-hidden md:mb-[130px]">
      ...
      {open && (
        ...
        >
          <div className="rounded-[20px] z-30 bg-white w-[320px] py-5 sm:px-5 xs:px-[27px] ">
