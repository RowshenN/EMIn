...
const Navigation2 = () => {
  ...
  return (
    <div
      className={`nav_inner2 ${isSticky ? "navigation_active" : "nav_inner2"}`}
      //   className="navigation_container2"
      //   style={
      //     isSticky
    ...
    >
      <div className="nav_inner_container">
        <div
          ...
          className="nav_logo_div"
        >
          <img src={logo} alt="logo" />
        </div>

        <div className="nav_list_container2">
          <ul>
            <li
        ...
        <div className="nav_burger_container">
          ...
          >
            <div className="nav_burger_button">
              <span className="nav_burger2"></span>
            </div>
          </div>
        </div>
      </div>
...
export default React.memo(Navigation2);
